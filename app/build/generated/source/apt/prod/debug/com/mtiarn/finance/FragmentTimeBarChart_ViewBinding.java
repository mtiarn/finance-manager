...
public class FragmentTimeBarChart_ViewBinding implements Unbinder {
  private FragmentTimeBarChart target;

  @UiThread
  public FragmentTimeBarChart_ViewBinding(FragmentTimeBarChart target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentTimeBarChart target = this.target;
