...
//    public static final String PREF_SHOW_SHOW_ACCOUNTS_PANEL = "show_accounts_panel";
    ...
    public static final String ACT_NEW_EXPENSE = "com.mtiarn.finance.ACT_NEW_EXPENSE";
    public static final String ACT_NEW_INCOME = "com.mtiarn.finance.ACT_NEW_INCOME";
    public static final String ACT_NEW_TRANSFER = "com.mtiarn.finance.ACT_NEW_TRANSFER";
    public static final String ACT_SHOW_TEMPLATES = "com.mtiarn.finance.ACT_SHOW_TEMPLATES";
    public static final String ACT_CLEAR_NEW_TRANSACTIONS_COUNTER = "com.mtiarn.finance.intent.action.CLEAR_NEW_TRANSACTION_COUNTER";
    public static final String ACT_CALC_DONE = "com.mtiarn.finance.intent.action.ACT_CALC_DONE";
    //</editor-fold>
