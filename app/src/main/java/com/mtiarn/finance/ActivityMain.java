...
import com.mtiarn.finance.adapter.TransactionsArrayAdapter;
                    ...
                    if (drawerItem instanceof PrimaryDrawerItem) {
                        ...
                        switch ((int) drawerItem.getIdentifier()) {
                            ...
                            case DRAWER_ITEM_ID_HELP: {
                                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://mtiarn.com/"));
                            ...
                            case DRAWER_ITEM_ID_SUPPORT: {
                                ...
                                intent.putExtra(Intent.EXTRA_EMAIL,  new String[] {"mgladkov469@gmail.com"});
